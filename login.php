...
<body style="background: url(images/bank1.jpg);background-size: 100%">
<h1 class="alert alert-warning rounded-0"><?php echo bankName; ?><small class="float-right text-muted" style="font-size: 12pt;"><kbd>Presented by:Vanshika Dangi</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
<div id="accordion" role="tablist" class="w-25 float-right shadowBlack" style="margin-right: 570px">
